...
/*const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("Ohayo! yukihirav2 is officially released enjoy");
    res.end();
});*/
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "Nibir007.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
axios.get("https://raw.githubusercontent.com/nibir6210/500Command/main/package.json").then((res) => {
    logger(res['data']['name'], "[ Nibir ]");
